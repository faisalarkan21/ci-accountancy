            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 " data-aos="zoom-in" data-aos-delay="400">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <a href="<?= base_url('/keuangan/jenis_penerimaan')?>">
                                <div class="card-header">
                                </div>
                                <div class="card-body">
                                    Jenis Penerimaan
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-aos="zoom-in" data-aos-delay="600">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <a href="<?= base_url('/keuangan/penerimaan_kas')?>">
                                <div class="card-header">
                                </div>
                                <div class="card-body">
                                    Penerimaan Kas
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-aos="zoom-in" data-aos-delay="800"
                    ...
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <a href="<?= base_url('/laporan/jurnal_umum_keuangan')?>">
                                <div class="card-header">
                                </div>
                                <div class="card-body">
                                    Jurnal Umum
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-aos="zoom-in" data-aos-delay="800"
                    ...
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <a href="<?= base_url('/laporan/buku_besar_keuangan')?>">
                                <div class="card-header">
                                </div>
                                <div class="card-body">
                                    Buku Besar
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-aos="zoom-in" data-aos-delay="800"
                    ...
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <a href="<?= base_url('/laporan/jurnal_penerimaan_kas')?>">
                                <div class="card-header">
                                </div>
                                <div class="card-body">
