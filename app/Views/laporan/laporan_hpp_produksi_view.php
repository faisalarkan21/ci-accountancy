    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Harga Pokok Produksi</div>
            </div>
        </div>
            ...
            <div class="card card-secondary">
                <div class="card-wrap">
                    <div class="card-header">
                        <h3><strong class="text-dark">Harga Pokok Produksi</strong></h3>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header text-dark">
                            Filter Laporan Harga Pokok Produksi
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body px-3 py-3">
                            ...
                            <table class="table  table-hover  border-top border-left border-bottom border-right">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <td class="text-left">Barang dalam proses awal</td>
                                        <td></td>
                                        <td class="text-center">-</td>
                                    </tr>
                                    <tr>
                                        <td class="text-left">Biaya produksi :</td>
                                    ...
                                    <tr>
                                        ...
                                        <?php if($row->kode_akun == '114-1') : ?>
                                        <td class="text-left">Rp. <?= number_format($row->kredit,0,',','.')?></td>
                                        <?php endif; ?>
                                        <?php } ?>
                                    </tr>
                                    <tr>
                                        <td class="text-left">Biaya Tenaga Kerja Langsung</td>
                                        <?php foreach($jurnal as $row){ ?>
                                        <?php if($row->kode_akun == '114-2') : ?>
                                        <td class="text-left">Rp. <?= number_format($row->kredit,0,',','.')?></td>
                                        <?php endif; ?>
                                        <?php } ?>
                                    </tr>
                                    <tr>
                                        <td class="text-left">Biaya Overhead Pabrik</td>
                                        <?php foreach($jurnal as $row){ ?>
                                        <?php if($row->kode_akun == '114-3') : ?>
