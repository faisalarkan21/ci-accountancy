            ...
            <div class="card card-secondary">
                <div class="card-wrap">
                    <div class="card-header">
                        <h3><strong class="text-dark">Laporan Pembelian</strong></h3>
                    </div>
                        ...
                        <div class="card-body px-3 py-3">
                            ...
                            <table class="table table-lg table-bordered table-hover text-dark bg-light ">
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td class="text-center"><?= date_indo($row['tgl_pembelian'])?></td>
                                        <td class="text-center"><?= ($row['nama_bahan'])?></td>
                                        <td class="text-center">Rp. <?= number_format(($row['biaya_bahan']),0,',','.')?>
                                        </td>
                                        <td class="text-center"><?= ($row['jmlh_pembelian'])?></td>
                                        <td class="text-center">Rp.
                                            <?= number_format(($row['biaya_bahan']*$row['jmlh_pembelian']),0,',','.')?>
                                        </td>
                                    </tr>
                                    <?php
                                    $totjmlh= $totjmlh+$row['jmlh_pembelian'];
                                    $totharga=$totharga+($row['biaya_bahan']*$row['jmlh_pembelian']);
                                     ?>
                                    ...
                                    <tr class='font-weight-bold'>
                                        ...
                                        <?php  ?>
                                        <td class="text-center"><?= ($totjmlh)?></td>
                                        <td class="text-center">Rp.
                                            <?= number_format(($totharga),0,',','.')?>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
