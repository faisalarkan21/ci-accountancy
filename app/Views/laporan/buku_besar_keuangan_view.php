                        ...
                        <table class="table table-bordered table-hover bg-light">
                            ...
                            <tbody class="text-dark">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">Kas</td>
                                    <?php elseif($row->kode_akun == '212-1'  ) : ?>
                                    <td class="text-center">Kas</td>
                                    <?php elseif($row->kode_akun == '212-2'  ) : ?>
                                    <td class="text-center">Kas</td>
                                    <?php elseif($row->kode_akun == '311-2'  ) : ?>
                                    <td class="text-center">Kas</td>
                                    <?php elseif($row->kode_akun == '311-1'  ) : ?>
                                    <td class="text-center">Kas</td>
                                    <?php elseif($row->kode_akun == '411'  ) : ?>
                                    <td class="text-center">Kas</td>
                                    <?php elseif($row->kode_akun == '115-1'  ) : ?>
                                    <td class="text-center">Harga pokok penjualan</td>
                                    <?php elseif($row->kode_akun == '411-4'  ) : ?>
                                    <td class="text-center">Persedian Barang Jadi</td>
                                    <?php elseif($row->kode_akun == '411-2'  ) : ?>
                                    <td class="text-center">Piutang usaha</td>
                                    <?php elseif($row->kode_akun == '113'  ) : ?>
                                    <td class="text-center">Retur Penjualan</td>
                                    ...
                                    <?php elseif($row->id == 'BA1'  ) : ?>
                                    <td class="text-center">Bangunan</td>
                                    <?php elseif($row->id == 'UPB1'  ) : ?>
                                    <td class="text-center">Utang Pembelian Bahan</td>
                                    <?php elseif($row->id == 'UG1'  ) : ?>
                                    <td class="text-center">Utang Gaji</td>
                                    <?php elseif($row->id == 'PRV1'  ) : ?>
                                    <td class="text-center">Prive</td>
                                    <?php elseif($row->id == 'MA1'  ) : ?>
                                    <td class="text-center">Modal Awal</td>
                                    <?php elseif($row->id == 'PENJ1'  ) : ?>
                                    ...
                                    <td class="text-center">111</td>
                                    <?php elseif($row->kode_akun == '115-1'  ) : ?>
                                    <td class="text-center">411-4</td>
                                    <?php elseif($row->kode_akun == '411-4'  ) : ?>
                                    <td class="text-center">115-1</td>
                                    <?php elseif($row->kode_akun == '411-2'  ) : ?>
                                    <td class="text-center">113</td>
                                    <?php elseif($row->kode_akun == '113'  ) : ?>
                                    <td class="text-center">411-2</td>
                                    ...
                                    <?php elseif($row->id == 'BA1'  ) : ?>
                                    <td class="text-center">121-2</td>
                                    <?php elseif($row->id == 'UPB1'  ) : ?>
                                    <td class="text-center">212-1</td>
                                    <?php elseif($row->id == 'UG1'  ) : ?>
                                    <td class="text-center">212-2</td>
                                    <?php elseif($row->id == 'PRV1'  ) : ?>
                                    <td class="text-center">311-2</td>
                                    <?php elseif($row->id == 'MA1'  ) : ?>
                                    <td class="text-center">311-1</td>
                                    <?php elseif($row->id == 'PENJ1'  ) : ?>
                                    ...
                                    <td class="text-center">
                                        <?php if($_POST['coa']=="Kas" ){ ?>
                                        Rp. <?= number_format(($kredit2),0,',','.')?>

                                        <?php }elseif($_POST['coa']=="Kas"  && $row->debet == 0){ ?>

                                        -
                                        <?php }elseif($row->debet == 0 && $_POST['coa']!=="Kas"){ ?>
                                        -
                                        <?php }elseif($row->debet !== 0 && $_POST['coa']!=="Kas"){ ?>
                                        Rp. <?= number_format($row->debet,0,',','.')?>
                                    ...
                                    <td class="text-center">
                                        <?php if($_POST['coa'] !=="Kas" && $row->kredit == 0){ ?>
                                        -
                                        <?php }elseif($_POST['coa'] !=="Kas" && $row->kredit !== 0){ ?>
                                        Rp. <?= number_format($row->kredit,0,',','.')?>

                                        <?php }elseif($_POST['coa'] =="Kas" && $row->kredit == 0 && $row->debet !== 0){ ?>
                                        <?php }elseif($_POST['coa'] =="Kas" && $row->kredit !== 0){ ?>
